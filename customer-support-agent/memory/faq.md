...
- If the answer depends on the customer's specific account, order, or anything you'd need to look up, leave it out. Those should always be drafts.

---

<!-- Seeded during setup. Add more entries below in the same format. -->

**Q:** *Example: How do I reset my password?*
**A:** *Example: You can reset your password from the login page by clicking "Forgot password" and entering the email on your account. The reset link is good for 30 minutes.*
