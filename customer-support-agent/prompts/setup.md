...
Ask: **"What are 3 to 5 questions your customers ask you over and over? Give me each one and how you usually answer it. The Customer Support Agent will use these to decide which customer emails to mark READY TO SEND. Anything else gets marked DRAFT for you to review."**
...
> - **FAQ**
>
> Any time you want to run a scan, open a new chat in this Project and paste the contents of `prompts/scan-and-respond.md`, then either paste customer emails below it or ask me to read them via your connected Gmail or email tool."
